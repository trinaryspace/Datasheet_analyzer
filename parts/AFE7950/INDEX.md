...
- `app_note`  — 12 pages — `docs/app_note-4e589008/`
- `app_note`  — 12 pages — `docs/app_note-5731d2b0/`
...
## Section map — `app_note-4e589008`

- **Table of Contents** — p.1 — `docs/app_note-4e589008/sections/table-of-contents.md` (1524 tok)
- **Trademarks** — p.1 — `docs/app_note-4e589008/sections/trademarks.md` (1522 tok)
- **1 Introduction** — p.2 — `docs/app_note-4e589008/sections/1-introduction.md` (916 tok)
- **2 SPI Failure During Bring-Up** — p.2-3 — `docs/app_note-4e589008/sections/2-spi-failure-during-bring-up.md` (1592 tok)
- **2.1 Detail Regarding Chip Readouts** — p.2 — `docs/app_note-4e589008/sections/2-1-detail-regarding-chip-readouts.md` (921 tok)
- **2.2 Failure and Fix for Chip Read Check** — p.2 — `docs/app_note-4e589008/sections/2-2-failure-and-fix-for-chip-read-check.md` (922 tok)
- **2.3 Poll Check for SPI Access for PLL Page** — p.3 — `docs/app_note-4e589008/sections/2-3-poll-check-for-spi-access-for-pll-page.md` (708 tok)
- **2.4 Failure and Fix for the SPI Poll Check for PLL Page Access** — p.3 — `docs/app_note-4e589008/sections/2-4-failure-and-fix-for-the-spi-poll-check-for-pll-page-acce.md` (713 tok)
- **2.5 Read Check Indicating Status of Fuse Farm Autoload** — p.3 — `docs/app_note-4e589008/sections/2-5-read-check-indicating-status-of-fuse-farm-autoload.md` (711 tok)
- **2.6 Failure and Fix for Autoload Read Check** — p.3 — `docs/app_note-4e589008/sections/2-6-failure-and-fix-for-autoload-read-check.md` (708 tok)
- **3 Macro Failure Breaking the Bring-Up Flow** — p.4 — `docs/app_note-4e589008/sections/3-macro-failure-breaking-the-bring-up-flow.md` (1051 tok)
- **3.1 Read Check for Macro Error and Poll Check for Macro Done** — p.4 — `docs/app_note-4e589008/sections/3-1-read-check-for-macro-error-and-poll-check-for-macro-done.md` (1056 tok)
- **3.2 Failure and Fix for Macro Error and Poll check for Macro Done** — p.4 — `docs/app_note-4e589008/sections/3-2-failure-and-fix-for-macro-error-and-poll-check-for-macro.md` (1057 tok)
- **4 AFE PLL Failure** — p.5 — `docs/app_note-4e589008/sections/4-afe-pll-failure.md` (549 tok)
- **4.1 Read Check for PLL Lock** — p.5 — `docs/app_note-4e589008/sections/4-1-read-check-for-pll-lock.md` (552 tok)
- **4.2 Failure and Fix for Read Check of PLL** — p.5 — `docs/app_note-4e589008/sections/4-2-failure-and-fix-for-read-check-of-pll.md` (555 tok)
- **5 AFE Internal Sysref Flag Failure** — p.6 — `docs/app_note-4e589008/sections/5-afe-internal-sysref-flag-failure.md` (615 tok)
- **5.1 Read Check Status of Sysref Flag Bit** — p.6 — `docs/app_note-4e589008/sections/5-1-read-check-status-of-sysref-flag-bit.md` (617 tok)
- **5.2 Failure and Fix for Read Check Status of Sysref Flag Bit** — p.6 — `docs/app_note-4e589008/sections/5-2-failure-and-fix-for-read-check-status-of-sysref-flag-bit.md` (622 tok)
- **6 JESD Link Check Failure** — p.6-8 — `docs/app_note-4e589008/sections/6-jesd-link-check-failure.md` (1573 tok)
- **6.1 Multiple Read Checks Indicating Status of JESD Linkup** — p.6-7 — `docs/app_note-4e589008/sections/6-1-multiple-read-checks-indicating-status-of-jesd-linkup.md` (1134 tok)
- **6.2 Failure and Fix for JESD Error** — p.8 — `docs/app_note-4e589008/sections/6-2-failure-and-fix-for-jesd-error.md` (481 tok)
- **7 Validating Serdes and JESD Link using CAPI** — p.9-10 — `docs/app_note-4e589008/sections/7-validating-serdes-and-jesd-link-using-capi.md` (1150 tok)
- **7.1 Useful Serdes Debug CAPIs** — p.9 — `docs/app_note-4e589008/sections/7-1-useful-serdes-debug-capis.md` (605 tok)
- **7.2 Useful JESD Debug CAPIs** — p.10 — `docs/app_note-4e589008/sections/7-2-useful-jesd-debug-capis.md` (573 tok)
- **8 TX Chain Validation** — p.11 — `docs/app_note-4e589008/sections/8-tx-chain-validation.md` (873 tok)
- **9 RX Chain Validation** — p.11 — `docs/app_note-4e589008/sections/9-rx-chain-validation.md` (873 tok)
- **10 Device Health** — p.11 — `docs/app_note-4e589008/sections/10-device-health.md` (872 tok)
- **11 Summary** — p.11 — `docs/app_note-4e589008/sections/11-summary.md` (870 tok)
- **12 References** — p.11-12 — `docs/app_note-4e589008/sections/12-references.md` (1349 tok)

## Section map — `app_note-5731d2b0`

- **Table of Contents** — p.1 — `docs/app_note-5731d2b0/sections/table-of-contents.md` (1218 tok)
- **Trademarks** — p.1 — `docs/app_note-5731d2b0/sections/trademarks.md` (1216 tok)
- **1 Introduction** — p.2 — `docs/app_note-5731d2b0/sections/1-introduction.md` (577 tok)
- **1.1 Cascaded LMX1204 Design** — p.2 — `docs/app_note-5731d2b0/sections/1-1-cascaded-lmx1204-design.md` (580 tok)
- **2 Results** — p.3-10 — `docs/app_note-5731d2b0/sections/2-results.md` (2485 tok)
- **2.1 Single Device Performance** — p.3 — `docs/app_note-5731d2b0/sections/2-1-single-device-performance.md` (271 tok)
- **2.2 Cascaded Device Performance** — p.4 — `docs/app_note-5731d2b0/sections/2-2-cascaded-device-performance.md` (198 tok)
- **2.3 Detailed Results** — p.5-9 — `docs/app_note-5731d2b0/sections/2-3-detailed-results.md` (1422 tok)
- **2.3.1 1 GHz Performance** — p.5 — `docs/app_note-5731d2b0/sections/2-3-1-1-ghz-performance.md` (392 tok)
- **2.3.2 3 GHz Performance** — p.6 — `docs/app_note-5731d2b0/sections/2-3-2-3-ghz-performance.md` (410 tok)
- **2.3.3 6 GHz Performance** — p.7 — `docs/app_note-5731d2b0/sections/2-3-3-6-ghz-performance.md` (272 tok)
- **2.3.4 10 GHz Performance** — p.8 — `docs/app_note-5731d2b0/sections/2-3-4-10-ghz-performance.md` (179 tok)
- **2.3.5 12.8 GHz Performance** — p.9 — `docs/app_note-5731d2b0/sections/2-3-5-12-8-ghz-performance.md` (296 tok)
- **2.4 Cascaded LMX1204 Performance With ADC32RF54** — p.10 — `docs/app_note-5731d2b0/sections/2-4-cascaded-lmx1204-performance-with-adc32rf54.md` (702 tok)
- **2.5 Cascaded LMX1204 Performance With AFE7950** — p.10 — `docs/app_note-5731d2b0/sections/2-5-cascaded-lmx1204-performance-with-afe7950.md` (701 tok)
- **3 Summary** — p.11 — `docs/app_note-5731d2b0/sections/3-summary.md` (294 tok)
- **4 References** — p.11-12 — `docs/app_note-5731d2b0/sections/4-references.md` (773 tok)
