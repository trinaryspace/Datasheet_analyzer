...
class TestTheInvariantsThisDesignPutAtRisk:
    ...
    def test_the_layout_backend_output_version_is_unchanged(self):
        ...
        `tables-10`, moved by the bit-field region fix (ticket 06 un-park),
        which changed what the table regions contain and therefore owns a
        re-extraction; `tables-09` before it was phase 6.5 wave 2's bump.
        What is pinned here is that no GUI ticket touched it.
        """
