...
completion records). `KNOWN_SHORTCOMINGS.md` is the other side of that ledger:
...
| LMX1204 | unknown* | SNAS800B + SNAU269A | 72 + 25 | 79 | 96/25 | 853 | 54 | 16 Q @ 100% (10 text + 4 register + 2 path) |
...
5. **Golden Q&A is the objective function.** Per-part benchmarks at
   ...
   or empty — every corpus is provably verified or provably not. Extend
    ...
    HMC520A 15 Q, and — phase 6, tickets 05–06 — LMX1204 16 Q, whose set is
    ...
    `CLK_MUX` at `2:0`). Phase 5, ticket 09 added the two paths the phase itself
