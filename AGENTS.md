...
# test (fully offline, 1937 passing in ~6 min — the ungated phase-4 gate builds four real
...
| `evalh/golden.py` | Report rendering + token economics measurement. | `render_verification_report`, `render_spec_query_report`, `render_plot_query_report`, `render_pin_query_report`, `render_reg_query_report`, `render_card_query_report`, `render_ask_query_report`, `render_search_query_report`, `render_token_economics`, `estimate_lookup_tokens` |
