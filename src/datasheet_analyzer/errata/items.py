...
def _document_items(doc_name: str, raw: RawDocument, lexicon: ErrataLexicon) -> list[ErrataItem]:
    lines = [
    ...
    if not lines:
        log.warning("errata document %s printed no readable text — no items", doc_name)
        return []
