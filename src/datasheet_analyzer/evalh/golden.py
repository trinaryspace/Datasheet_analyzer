...
from datasheet_analyzer.evalh.candidates import CANDIDATE_SUFFIX
...
def candidate_golden_path(part: str) -> Path:
    """`tests/fixtures/golden_qa_<PART>.candidate.yaml` — generated proposals.
...
def rejected_golden_path(part: str) -> Path:
    """`tests/fixtures/golden_qa_<PART>.rejected.yaml` — the rejection ledger."""
