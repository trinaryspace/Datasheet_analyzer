...
#: that the datasheet behind that row has been superseded. `state: ""` means no
#: single corpus was in scope (`list_parts`, `compare_parts`); it is *not* a
#: fourth state and must never be read as `current`.
